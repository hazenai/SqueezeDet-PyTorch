...
class YOLO(BaseDataset):
    def __init__(self, phase, cfg):
        ...
        self.data_dir = os.path.join(cfg.data_dir, 'LPR')
        ...
        #                                 [160, 152], [211, 201], [343, 205]], dtype=np.float32) ## real_filtered plus all_sites_seatbelt anchors trajectory


        self.anchors_seed = np.array([[12, 10], [22, 19], [35, 20], [36, 35], [39, 47], [60, 31]], dtype=np.float32) #LPR anchors
